      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Icon(Icons.copy, size: 18, color: AppColors.textTertiary),
          ),
        ),
      ),
    );
    ...
    showDialog<void>(
      ...
      builder: (dialogContext) {
        ...
        return AlertDialog(
          ...
          content: const Text('开启后，当自选股出现新的异动信息时，系统会自动进行语音播报，帮助您及时把握盘中变化。'),
          actions: [
            TextButton(
              onPressed: () async {
