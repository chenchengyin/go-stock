...
func TestPickPrevDayTag(t *testing.T) {
	cases := []struct {
		...
		{"最高刚好9.89且收盘更低", 9.89, 1.0, 9.84, "涨停破板"},
		{"最高9.85收盘更低不算破板", 9.85, 1.0, 9.84, ""},
		{"封死涨停不算破板", 10.0, 2.0, 10.0, ""},
		{"前一天跌停", 1.0, -2.0, -9.9, "前一天跌停"},
		{"前一天大阴线", 3.0, 5.0, 0.5, "前一天大阴线"},
		{"阴线实体刚好2%不标记", 3.0, 2.0, 0.0, ""},
		{"阴线实体超过2%标记", 3.0, 2.01, 0.0, "前一天大阴线"},
		{"阴线实体刚好8%标记", 3.0, 8.0, 0.0, "前一天大阴线"},
		{"阴线实体超过8%不标记", 3.0, 8.01, 0.0, ""},
